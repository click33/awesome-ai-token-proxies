...
> **说明** · 本仓库仅作信息聚合展示；各站点均由社区贡献，可用性与合规性请自行核实，请谨慎评估后使用。

**想补充新站点？** 请直接在 Gitee 或 GitHub 网页端编辑本仓库的 `README.md` 并保存，系统会自动生成轻量级 PR。
...
- https://evora-token-reseller.vercel.app/ - EVORA 脉流中转科技，提供 OpenAI 兼容接口，支持 Codex / CC Switch 等工具接入，按量能量计费，用量与扣费记录可查。
--- 
...
<img src="https://res.dev33.cn/contact/ai-coding-wx-group-qr.png?date=2026-08-24" width="230px" title="微信群" />
